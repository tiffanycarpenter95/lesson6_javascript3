...
function previewFive() {
   ...
   // create figure and image elements for fifth image
...
/*create even listeners for left arrow, right arrow, and center figure element*/
function createEventListeners(){
   ...
   var showAllButton = document.querySlector("#fiveButton p");
